...
parser.add_argument('scene', nargs='?', default="assets/free Dimensiva+3Dshaker_FREEpack_01/214 Silla Chair by Thonet/Silla Chair.blend",
                    help="Path to the object file.")
parser.add_argument('output_dir', nargs='?', default="random_backgrounds/output",
...
obj = bproc.loader.load_blend(args.scene)[0]
